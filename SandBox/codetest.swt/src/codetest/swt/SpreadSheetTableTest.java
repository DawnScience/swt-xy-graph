...
import codetest.swt.SpreadSheetTable.ITableEditingListener;
...
public void testMain() {
	...
	table.getTableViewer().getTable().getItem(1).setForeground(1,Display.getCurrent().getSystemColor(SWT.COLOR_BLUE));
	table.getTableViewer().getTable().getItem(1).setBackground(2,Display.getCurrent().getSystemColor(SWT.COLOR_CYAN));
	...
	table.addTableEditingListener(new ITableEditingListener() {
