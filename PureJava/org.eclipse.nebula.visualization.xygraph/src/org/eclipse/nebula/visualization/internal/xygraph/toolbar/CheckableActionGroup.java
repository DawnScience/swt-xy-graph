...
/**
 * Class behaves like swing ButtonGroup because I could not find a jface class
 * for this. Probably because Actions are not very commonly uses and actions are
 * configured via the plugin.xml
 */
